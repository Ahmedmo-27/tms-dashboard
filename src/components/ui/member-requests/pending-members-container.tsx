      ...
      <Card className="hidden md:block w-full">
        ...
        <CardContent className="pt-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex flex-1 items-center gap-2 max-w-md" data-walkthrough="member-requests-search">
          ...
          <div className="mt-6 rounded-md border" data-walkthrough="member-requests-table">
            {isLoading ? (
              <Loading />
            ) : (
              <div className="relative">
