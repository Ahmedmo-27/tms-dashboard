...
import { bookDropInAction } from "@/lib/actions/member-actions";
...
export default function BookDropIn({
  ...
  const [state, formAction, pending] = useActionState(
    async (currentState: any, formData: FormData) => {
      ...
      const result = await bookDropInAction(currentState, formData);
  ...
  return (
    <div>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Book a drop in</DialogTitle>
